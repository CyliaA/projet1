var Physical = pc.createScript('physical');

Physical.attributes.add('css', { type: 'asset', assetType: 'css', title: 'CSS Asset' });
Physical.attributes.add('html', { type: 'asset', assetType: 'html', title: 'HTML Asset' });

Physical.prototype.initialize = function() {
...
Physical.prototype.initializeForm = function(uniqueId) {
...
addYouTubeVideo('video-' + uniqueId + '-1', 'https://www.youtube.com/watch?v=j4p2iadA9p0'); 
addYouTubeVideo('video-' + uniqueId + '-2', 'https://www.youtube.com/watch?v=8a5NNIRh49I');
