var ScriptExperienceEnvironmental = pc.createScript('scriptExperienceEnvironmental');

// Ajouter des attributs pour les entités avatar et bouton
ScriptExperienceEnvironmental.attributes.add('avatarEntity', { type: 'entity' });
ScriptExperienceEnvironmental.attributes.add('buttonEntity', { type: 'entity' });

// Initialisation
ScriptExperienceEnvironmental.prototype.initialize = function() {
...
ScriptExperienceEnvironmental.prototype.startExperience = function() {
...
ScriptExperienceEnvironmental.prototype.presentWellBeingDimensions = function() {
    var texte = [
      "Environmental Well-being. Here, we emphasize living in harmony with our surroundings and taking care of our planet."   ];
...
ScriptExperienceEnvironmental.prototype.animateMorphTargets = function(text) {
...
ScriptExperienceEnvironmental.prototype.startEyeBlinking = function() {
    var morphInstance = this.morphInstance;
    var morphTargetIndices = this.morphTargetIndices;
