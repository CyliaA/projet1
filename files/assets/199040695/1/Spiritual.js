   ...
   var Spiritual = pc.createScript('spiritual');

Spiritual.attributes.add('css', { type: 'asset', assetType: 'css', title: 'CSS Asset' });
Spiritual.attributes.add('html', { type: 'asset', assetType: 'html', title: 'HTML Asset' });

Spiritual.prototype.initialize = function() {
...
Spiritual.prototype.initializeForm = function(uniqueId) {
   ...
   addYouTubeVideo('video-' + uniqueId + '-1', 'https://www.youtube.com/watch?v=tH1i2zH0Afc');
