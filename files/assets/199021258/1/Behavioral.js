var Behavioral = pc.createScript('behavioral');

Behavioral.attributes.add('css', { type: 'asset', assetType: 'css', title: 'CSS Asset' });
Behavioral.attributes.add('html', { type: 'asset', assetType: 'html', title: 'HTML Asset' });

Behavioral.prototype.initialize = function() {
...
Behavioral.prototype.initializeForm = function(uniqueId) {
    ...
    addYouTubeVideo('video-' + uniqueId + '-1', 'https://www.youtube.com/watch?v=Zq6CqzkjZrw');
