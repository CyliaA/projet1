var ScriptExperienceOccupational = pc.createScript('scriptExperienceOccupational');

// Ajouter des attributs pour les entités avatar et bouton
ScriptExperienceOccupational.attributes.add('avatarEntity', { type: 'entity' });
ScriptExperienceOccupational.attributes.add('buttonEntity', { type: 'entity' });

// Initialisation
ScriptExperienceOccupational.prototype.initialize = function() {
...
ScriptExperienceOccupational.prototype.startExperience = function() {
...
ScriptExperienceOccupational.prototype.presentWellBeingDimensions = function() {
    var texte = [
      "occupational well-being. This includes job satisfaction, stress management, and work-life balance."   ];
...
ScriptExperienceOccupational.prototype.animateMorphTargets = function(text) {
...
ScriptExperienceOccupational.prototype.startEyeBlinking = function() {
    var morphInstance = this.morphInstance;
    var morphTargetIndices = this.morphTargetIndices;
