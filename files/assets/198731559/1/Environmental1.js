var Environmental1 = pc.createScript('environmental1');

Environmental1.attributes.add('css', { type: 'asset', assetType: 'css', title: 'CSS Asset' });
Environmental1.attributes.add('html', { type: 'asset', assetType: 'html', title: 'HTML Asset' });
...
Environmental1.prototype.initialize = function() {
...
Environmental1.prototype.initializeForm = function() {
...
Environmental1.prototype.submitSurvey = function() {
