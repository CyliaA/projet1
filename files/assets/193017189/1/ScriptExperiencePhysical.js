var ScriptExperiencePhysical = pc.createScript('scriptExperiencePhysical');

// Ajouter des attributs pour les entités avatar et bouton
ScriptExperiencePhysical.attributes.add('avatarEntity', { type: 'entity' });
ScriptExperiencePhysical.attributes.add('buttonEntity', { type: 'entity' });

// Initialisation
ScriptExperiencePhysical.prototype.initialize = function() {
...
ScriptExperiencePhysical.prototype.startExperience = function() {
...
ScriptExperiencePhysical.prototype.presentWellBeingDimensions = function() {
    var texte = [
...
ScriptExperiencePhysical.prototype.animateMorphTargets = function(text) {
...
ScriptExperiencePhysical.prototype.startEyeBlinking = function() {
    var morphInstance = this.morphInstance;
    var morphTargetIndices = this.morphTargetIndices;
