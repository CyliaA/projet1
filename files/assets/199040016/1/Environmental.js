var Environmental = pc.createScript('environmental');

Environmental.attributes.add('css', { type: 'asset', assetType: 'css', title: 'CSS Asset' });
Environmental.attributes.add('html', { type: 'asset', assetType: 'html', title: 'HTML Asset' });

Environmental.prototype.initialize = function() {
...
Environmental.prototype.initializeForm = function(uniqueId) {
 ...
 addYouTubeVideo('video-' + uniqueId + '-1', 'https://www.youtube.com/watch?v=4Bz5ZwW1P7w'); 
 addYouTubeVideo('video-' + uniqueId + '-2', 'https://www.youtube.com/watch?v=jkty4uAJFyc');
