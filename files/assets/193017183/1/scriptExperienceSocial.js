var ScriptExperienceSocial = pc.createScript('scriptExperienceSocial');

// Ajouter des attributs pour les entités avatar et bouton
ScriptExperienceSocial.attributes.add('avatarEntity', { type: 'entity' });
ScriptExperienceSocial.attributes.add('buttonEntity', { type: 'entity' });

// Initialisation
ScriptExperienceSocial.prototype.initialize = function() {
...
ScriptExperienceSocial.prototype.startExperience = function() {
...
ScriptExperienceSocial.prototype.presentWellBeingDimensions = function() {
    var texte = [
      "Social Well-being. This dimension is about fostering meaningful connections and building a supportive network of relationships."   ];
...
ScriptExperienceSocial.prototype.animateMorphTargets = function(text) {
...
ScriptExperienceSocial.prototype.startEyeBlinking = function() {
    var morphInstance = this.morphInstance;
    var morphTargetIndices = this.morphTargetIndices;
