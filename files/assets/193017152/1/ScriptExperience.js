var ScriptExperience = pc.createScript('scriptExperience');

// Ajouter des attributs pour les entités avatar et bouton
ScriptExperience.attributes.add('avatarEntity', { type: 'entity' });
ScriptExperience.attributes.add('buttonEntity', { type: 'entity' });

// Initialisation
ScriptExperience.prototype.initialize = function() {
...
ScriptExperience.prototype.startExperience = function() {
...
ScriptExperience.prototype.presentWellBeingDimensions = function() {
    var texte = [
       // "Thank you for making your well-being a priority and for visiting us today. Before you log out, please take a moment to rate your experience on a scale from 1 to 10 and share how you are feeling after this experience by selecting an emoji. We truly appreciate your time and look forward to seeing you again for your next workshop tomorrow. Take care and be well!"
    "Thank you for prioritizing your well-being and prioritizing your wellbeing today. Before you log out, please take a moment to rate your experience on a scale from 1 to 10. Share how you are feeling by selecting an emoji that best reflects your mood after this experience and access your full experience report. We truly value your time and look forward to welcoming you back for your next workshop tomorrow. Take care, and be well."
    ];
...
ScriptExperience.prototype.animateMorphTargets = function(text) {
...
ScriptExperience.prototype.startEyeBlinking = function() {
    var morphInstance = this.morphInstance;
    var morphTargetIndices = this.morphTargetIndices;
...
function lireTexte(texte, voiceIndex = 122, volume = 1, rate = 1) {
