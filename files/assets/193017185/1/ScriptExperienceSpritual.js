var ScriptExperienceSpritual = pc.createScript('scriptExperienceSpritual');

// Ajouter des attributs pour les entités avatar et bouton
ScriptExperienceSpritual.attributes.add('avatarEntity', { type: 'entity' });
ScriptExperienceSpritual.attributes.add('buttonEntity', { type: 'entity' });

// Initialisation
ScriptExperienceSpritual.prototype.initialize = function() {
...
ScriptExperienceSpritual.prototype.startExperience = function() {
...
ScriptExperienceSpritual.prototype.presentWellBeingDimensions = function() {
    var texte = [
      "The Spiritual Well-being. This dimension guides you in finding purpose and meaning in life, through practices like meditation, prayer, or personal reflection."   ];
...
ScriptExperienceSpritual.prototype.animateMorphTargets = function(text) {
...
ScriptExperienceSpritual.prototype.startEyeBlinking = function() {
    var morphInstance = this.morphInstance;
    var morphTargetIndices = this.morphTargetIndices;
