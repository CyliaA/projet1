var ScriptExperienceEmotion = pc.createScript('scriptExperienceEmotion');

// Ajouter des attributs pour les entités avatar et bouton
ScriptExperienceEmotion.attributes.add('avatarEntity', { type: 'entity' });
ScriptExperienceEmotion.attributes.add('buttonEntity', { type: 'entity' });

// Initialisation
ScriptExperienceEmotion.prototype.initialize = function() {
...
ScriptExperienceEmotion.prototype.startExperience = function() {
...
ScriptExperienceEmotion.prototype.presentWellBeingDimensions = function() {
    var texte = [
      "The  Emotional and intellectual Well-being. This focuses on understanding and managing your feelings, and nurturing a positive outlook on life."   ];
...
ScriptExperienceEmotion.prototype.animateMorphTargets = function(text) {
...
ScriptExperienceEmotion.prototype.startEyeBlinking = function() {
    var morphInstance = this.morphInstance;
    var morphTargetIndices = this.morphTargetIndices;
