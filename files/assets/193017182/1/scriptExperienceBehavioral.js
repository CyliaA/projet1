var ScriptExperienceBehavioral = pc.createScript('scriptExperienceBehavioral');

// Ajouter des attributs pour les entités avatar et bouton
ScriptExperienceBehavioral.attributes.add('avatarEntity', { type: 'entity' });
ScriptExperienceBehavioral.attributes.add('buttonEntity', { type: 'entity' });

// Initialisation
ScriptExperienceBehavioral.prototype.initialize = function() {
...
ScriptExperienceBehavioral.prototype.startExperience = function() {
...
ScriptExperienceBehavioral.prototype.presentWellBeingDimensions = function() {
    var texte = [
      "Behavioral Well-being. This dimension helps you build healthy habits and practices that enhance your overall wellness."   ];
...
ScriptExperienceBehavioral.prototype.animateMorphTargets = function(text) {
...
ScriptExperienceBehavioral.prototype.startEyeBlinking = function() {
    var morphInstance = this.morphInstance;
    var morphTargetIndices = this.morphTargetIndices;
