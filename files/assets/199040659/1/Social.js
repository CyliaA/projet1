...
Social.attributes.add('css', { type: 'asset', assetType: 'css', title: 'CSS Asset' });
Social.attributes.add('html', { type: 'asset', assetType: 'html', title: 'HTML Asset' });
...
Social.prototype.initializeForm = function(uniqueId) {
    ...
    addYouTubeVideo('video-' + uniqueId + '-1', 'https://www.youtube.com/watch?v=gkwrX6EfDec');
    addYouTubeVideo('video-' + uniqueId + '-2', 'https://www.youtube.com/watch?v=pltKQbD_yxI');
    addYouTubeVideo('video-' + uniqueId + '-3', 'https://www.youtube.com/watch?v=lbfKkega80c');
    addYouTubeVideo('video-' + uniqueId + '-4', 'https://www.youtube.com/watch?v=zmvBTCOzO7w');
